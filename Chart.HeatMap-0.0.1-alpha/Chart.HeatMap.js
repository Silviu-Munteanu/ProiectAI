  ...
  Chart.Type.extend({
    ...
    initialize: function (data) {
          ...
          if (this.display) {
            ...
            helpers.each(
              ...
              function (labelString, index) {
                var yLabelCenter =
                    this.endPoint - yLabelGap * index - yLabelGap * 0.5,
            ...
            helpers.each(
              ...
              function (label, index) {
                var xPos =
                    this.calculateX(index) + helpers.aliasPixel(this.lineWidth),
      ...
      if (this.options.showTooltips) {
        helpers.bindEvents(this, this.options.tooltipEvents, function (evt) {
          var activeBox =
            evt.type !== "mouseout" ? this.getBoxAtEvent(evt) : undefined;
    ...
    getBoxAtEvent: function (e) {
      ...
      for (
        ...
        for (
          boxIndex = 0;
          boxIndex < this.datasets[datasetIndex].boxes.length;
          boxIndex++
        ) {
          if (
            this.datasets[datasetIndex].boxes[boxIndex].inRange(
              eventPosition.x,
              eventPosition.y
            )
          ) {
    ...
    findMaxAndMin: function (reset) {
      ...
      this.eachBoxes(function (box, index, datasetIndex) {
        if (box.value > this.max) {
          this.max = box.value;
        }
        if (box.value < this.min) {
          this.min = box.value;
        }
      });
    },
    ...
    addData: function (valuesArray, label) {
      ...
      helpers.each(
        ...
        function (value, datasetIndex) {
          this.datasets[datasetIndex].boxes.push(
            new this.BoxClass({
              value: value,
              label: label,
